/* SQL Manager for MySQL                              5.9.0.55065 */
/* -------------------------------------------------------------- */
/* Host     : localhost                                           */
/* Port     : 3306                                                */
/* Database : ShemetovRG                                          */
...
CREATE TABLE `otryad` (
  ...
  UNIQUE KEY `IDOtr_2` USING BTREE (`IDOtr`),
...
CREATE TABLE `transport` (
  ...
  UNIQUE KEY `IDTr_2` USING BTREE (`IDTr`),
...
CREATE TABLE `sosttr` (
  `IDOtr` INTEGER DEFAULT NULL,
  `IDTr` INTEGER DEFAULT NULL,
  UNIQUE KEY `IDOtr` USING BTREE (`IDOtr`),
  UNIQUE KEY `IDTr` USING BTREE (`IDTr`),
...
INSERT INTO `sotrudniki` (`ID`, `FIO`, `Gender`, `Old`, `Zvanie`, `IDOtr`) VALUES
  ...
  (15,'Владимир Рутин',1,22,'Сержант',5);
COMMIT;
